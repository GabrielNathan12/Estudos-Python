...
with ZipFile(CAMINHO_COMPACTADO, 'w') as arquivo:
    for root, dirs, files in os.walk(CAMINHO_ZIP_DIR):
        for file in files:
            arquivo.write(os.path.join(root, file), file)




with ZipFile(CAMINHO_COMPACTADO, 'r') as arquivo:
    for arq in arquivo.namelist():
        print(arq)

with ZipFile(CAMINHO_COMPACTADO, 'r') as arquivo:
    arquivo.extractall(CAMINHO_DESCOMPACTADO)